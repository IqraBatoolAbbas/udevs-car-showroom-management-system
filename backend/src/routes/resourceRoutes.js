...
const applications = createRoutes(applicationController, ['admin', 'sales', 'customer']);
...
router.use('/activity-logs', createRoutes(makeResourceController(ActivityLog, ['description']), ['admin', 'sales', 'inventory', 'customer']));
